...
# TODO enumerate subnets based on found IPs
# get-subnets-24.sh $domain 
# grep first subnet from *.$domain.ipv4
# TODO reverse look up IPs and add found hostnames to list
# host subnet/24
